...
/**
 * \file    test/phpunit/MMIAvisVerifiesFunctionalTest.php
...
/**
 * Class MMIAvisVerifiesFunctionalTest
 *
 ...
 *
 * @package Testmmiavisverifies
 */
class MMIAvisVerifiesFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modMMIAvisVerifies')->click();
		} else {
			// Disable the module
			$this->byHref('modMMIAvisVerifies')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/mmiavisverifies/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('mmiavisverifies/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/mmiavisverifies/admin/about.php');
		$this->authenticate();
		return $this->assertContains('mmiavisverifies/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('mmiavisverifieswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMMIAvisVerifies_MMIAvisVerifiesTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMMIAvisVerifies_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
